...
""",
    ...
    data = [
        ...
        (u"[[File:MyImage.png|arg=http://google.com|caption]]",
         u'<page><body><p><object alt="caption" xlink:href="wiki.local:MyImage.png?do=get&amp;arg=http%253A%252F%252Fgoogle.com">caption</object></p></body></page>'),
        (u"[[File:Test.png|do=get|arg1=test|arg2=something else]]",
         u'<page><body><p><object alt="Test.png" xlink:href="wiki.local:Test.png?do=get&amp;arg2=something+else&amp;arg1=test">Test.png</object></p></body></page>'),
        ...
        (u"[[File:Test2.png|do=xxx|caption|arg1=test]]",
         u'<page><body><p><object alt="caption" xlink:href="wiki.local:Test2.png?do=xxx&amp;arg1=test">caption</object></p></body></page>'),
