...
class TestConverter(object):
    ...
    def test_base(self):
        data = [
            ...
            (u"`Text <javascript:alert('xss')>`_", u'<page><body><p><admonition type="error">Text</admonition></p></body></page>'),
...
c</p></list-item-body></list-item><list-item><list-item-body><p>b</p><p>d</p></list-item-body></list-item></list></body></page>'''),
            ...
            (u'* A\n\n   - B\n\n      + C\n\n   - D\n\n* E', '<page><body><list item-label-generate="unordered"><list-item><list-item-body><p>A</p><blockquote><list item-label-generate="unordered"><list-item><list-item-body><p>B</p><blockquote><list item-label-generate="unordered"><list-item><list-item-body><p>C</p></list-item-body></list-item></list></blockquote></list-item-body></list-item><list-item><list-item-body><p>D</p></list-item-body></list-item></list></blockquote></list-item-body></list-item><list-item><list-item-body><p>E</p></list-item-body></list-item></list></body></page>'),
   ...
   :alt: alternate text""", '<page><body><xinclude:include xhtml:alt="alternate text" xhtml:height="50" xhtml:width="100" xinclude:href="wiki.local:images/biohazard.png" /></body></page>'),
    ...
    def test_directive(self):
        data = [
            ...
            (u'.. macro:: <<Macro()>>', '<page><body><inline-part content-type="x-moin/macro;name=Macro" /></body></page>'),
            (u'.. macro:: Macro(arg)', '<page><body><inline-part content-type="x-moin/macro;name=Macro"><arguments>arg</arguments></inline-part></body></page>'),
            (u'test |a| test\n\n.. |a| macro:: <<Macro()>>', '<page><body><p>test <inline-part content-type="x-moin/macro;name=Macro" /> test</p></body></page>'),
