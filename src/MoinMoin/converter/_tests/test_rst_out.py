...
class TestConverter(Base):
    ...
    data = [
        ...
        u"""\n==\nh1\n==\n\nh2\n==\n\nh3\n--\n\nh4\n**\n\nh5\n::\n\nh6\n++\n"""),
        (
        u'<page:page><page:body><page:p>H<page:span page:baseline-shift="sub">2</page:span>O</page:p><page:p>E = mc<page:span page:baseline-shift="super">2</page:span></page:p></page:body></page:page>',
        u'H\\ :sub:`2`\\ O\n\nE = mc\\ :sup:`2`\\ \n'),
...
"""),
    ...
    data = [
        (
        u'<page:page><page:body><page:p>Abra <page:note page:note-class="footnote">arba</page:note></page:p></page:body></page:page>',
        u'Abra  [#]_ \n\n\n.. [#] arba\n\n'),
        (
...
"""),
        (
        u"<page:page><page:body><page:list page:item-label-generate=\"unordered\"><page:list-item><page:list-item-body><page:p>A</page:p><page:blockcode> test </page:blockcode></page:list-item-body></page:list-item></page:list></page:body></page:page>",
        u"\n* A\n::\n\n     test \n\n"),
        (
