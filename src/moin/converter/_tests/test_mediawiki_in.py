...
class TestConverter(object):
    ...
    data = [
        ...
        (u"'''''bold and italic'''''",
         u'<page><body><p><strong><emphasis>bold and italic</emphasis></strong></p></body></page>'),
        (u"<nowiki>no ''markup''</nowiki>\n\n<code>no ''markup''</code>\n\n<tt>no ''markup''</tt>",
         "<page><body><p><code>no ''markup''</code></p><p><code>no ''markup''</code></p><p><code>no ''markup''</code></p></body></page>"),
        (u"<pre>no ''markup'' block</pre>",
         u"<page><body><p><blockcode>no ''markup'' block</blockcode></p></body></page>"),
        ...
        (u"test <sup>super</sup> or <sub>sub</sub>",
         u'<page><body><p>test <span baseline-shift="super">super</span> or <span baseline-shift="sub">sub</span></p></body></page>'),
        (u"text <blockquote> quote quote quote quote quote quote </blockquote> text",
         u"<page><body><p>text <blockquote> quote quote quote quote quote quote </blockquote> text</p></body></page>"),
...
'''),
        ...
        # : definition
        (u";aaa : bbb",
         u"<page><body><list><list-item><list-item-label>aaa </list-item-label><list-item-body><p> bbb</p></list-item-body></list-item></list></body></page>"),
        (u""": Single indent
:: Double indent
::::: Multiple indent
""",
...
""",
    ...
    data = [
        ...
        (u"[http://external.link alt text]",
         u'<page><body><p><a xlink:href="http://external.link">alt text</a></p></body></page>'),
        (u"[[SomeLink|Some text]]",
         u'<page><body><p><a xlink:href="wiki.local:SomeLink">Some text</a></p></body></page>'),
        (u"[[SomeLink|arg1=value|arg2=otherval|Some text]]",
         u'<page><body><p><a xlink:href="wiki.local:SomeLink?arg1=value&amp;arg2=otherval">Some text</a></p></body></page>'),
        (u"[[File:Test.jpg|test]]",
         u'<page><body><p><object alt="test" xlink:href="wiki.local:Test.jpg?do=get">test</object></p></body></page>'),
        (u"[[File:MyImage.png]]",
         u'<page><body><p><object alt="MyImage.png" xlink:href="wiki.local:MyImage.png?do=get">MyImage.png</object></p></body></page>'),
        (u"[[File:MyImage.png|arg=http://google.com|caption]]",
         u'<page><body><p><object alt="caption" xlink:href="wiki.local:MyImage.png?arg=http%253A%252F%252Fgoogle.com&amp;do=get">caption</object></p></body></page>'),
        (u"[[File:Test.png|do=get|arg1=test|arg2=something else]]",
         u'<page><body><p><object alt="Test.png" xlink:href="wiki.local:Test.png?arg1=test&amp;arg2=something+else&amp;do=get">Test.png</object></p></body></page>'),
        # The do=xxx part is just to test if do in args is being updated correctly, it's invalid otherwise
        (u"[[File:Test2.png|do=xxx|caption|arg1=test]]",
         u'<page><body><p><object alt="caption" xlink:href="wiki.local:Test2.png?arg1=test&amp;do=xxx">caption</object></p></body></page>'),
        (u"[[File:myimg.png|'Graph showing width |= k for 5 < k < 10']]",
         u'<page><body><p><object alt="Graph showing width |= k for 5 &lt; k &lt; 10" xlink:href="wiki.local:myimg.png?do=get">Graph showing width |= k for 5 &lt; k &lt; 10</object></p></body></page>'),
        (u"[[File:myimg.png|arg1='longish caption value with |= to test'|arg2=other|test stuff]]",
         u'<page><body><p><object alt="test stuff" xlink:href="wiki.local:myimg.png?arg1=longish+caption+value+with+%257C%253D+to+test&amp;arg2=other&amp;do=get">test stuff</object></p></body></page>'),
        # Unicode test
        (u"[[File:Test.jpg|\xe8]]",
