...
class TestConverter(Base):
    ...
    data = [
        ...
        ('<page:p>Text</page:p>',
         'Text\n'),
        ('<page:tag><page:p>Text</page:p><page:p>Text</page:p></page:tag>',
         'Text\n\nText\n'),
        ('<page:separator />',
         '----\n'),
        ...
        ('<page:code>monospace</page:code>',
         '`monospace`'),
        ('<page:del>stroke</page:del>',
         '--(stroke)--'),
        ('<page:ins>underline</page:ins>',
         '__underline__'),
        ('<page:span page:font-size="120%">larger</page:span>',
         '~+larger+~'),
        ('<page:span page:font-size="85%">smaller</page:span>',
         '~-smaller-~'),
        ('<page:tag><page:span page:baseline-shift="super">super</page:span>script</page:tag>',
         '^super^script'),
        ('<page:tag><page:span page:baseline-shift="sub">sub</page:span>script</page:tag>',
         ',,sub,,script'),
    ]
    ...
    data = [
        ('<page:page><page:body><page:p>A</page:p><page:separator /></page:body></page:page>',
         'A\n----\n'),
