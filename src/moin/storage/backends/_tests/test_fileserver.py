...
class TestFileServerBackend(BackendTestBase):
    ...
    def test_files(self):
        # Note: Because we can only store data in the file system, meta can
        # contain only items generated by the fileserver backend:
...
""".replace("\n", "\r\n").encode()
        ...
        for i in self.be:
            ...
            # We do not want to check some meta values
            del meta[MTIME]
