...
Typical usage:
 ...
 1. Create a profiler:
    ...
    from moin.utils.profile import Profiler
...
class Profiler:
    ...
    def _log(self):
        ...
        """
        line = (
            "%(date)s req:%(requests)d mem:%(memory)sKB collect:%(collect)s "
...
class TwistedProfiler(Profiler):
    ...
    def sample(self):
        ...
        deferred = self._getProcessOutput("/bin/ps", ("-p", str(self.pid), "-o", "rss"))
