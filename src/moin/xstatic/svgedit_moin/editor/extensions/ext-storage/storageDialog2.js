...
var template = null;
function initialize(svgeditPolicy) {
	template = document.createElement("template");
	template.innerHTML = svgeditPolicy.createHTML(storageDialog_default);
}
var cloneNodeAndSetNonce = function(node) {
...
//#endregion
export { SeStorageDialog, initialize };
